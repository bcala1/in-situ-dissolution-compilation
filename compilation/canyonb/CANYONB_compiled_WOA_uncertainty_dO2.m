...
headers = ["Latitude", "Longitude", "Depth", "Pressure", ...
    "InSitu_Temperature", "Salinity", "Doxy+0.001", "Year", "Month", ...
    "NO3", "PO4", "SiOH4", "TA", "DIC", 'pH_insitu'];

save_mat = nan(length(m(:,1)), length(headers));
writematrix(headers, "../data/compiled_WOA_CANYONBresults_uncertainty_dO2.csv");
...
writematrix(save_mat, "../data/compiled_WOA_CANYONBresults_uncertainty_dO2.csv", 'writemode', 'append');
