...
tic
% Load WOA variables
m = readmatrix('data/glodap22_recent_withWOA_forCANYONB.csv', ...
    Delimiter=",");
...
writematrix(headers, "data/glodap22_recent_canyonb_results.csv");
...
writematrix(save_mat, "data/glodap22_recent_canyonb_results.csv", 'writemode', 'append');
